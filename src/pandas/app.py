...
# read files
get_device = ps.read_json("/Users/jalvi/Desktop/jp-repos/de-spark/docs/files/device/*.json")
get_subscription = ps.read_json("/Users/jalvi/Desktop/jp-repos/de-spark/docs/files/subscription/*.json")
