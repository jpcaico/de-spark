...
def main():
    ...
    # extract {E}
    users_filepath = "/Users/jalvi/Desktop/jp-repos/de-spark/docs/files/parquet/users"
    ...
    # load {L}
    write_into_parquet(df=df_users_transformed, mode="overwrite", location="/Users/jalvi/Desktop/jp-repos/de-spark/docs/files/output/users")
