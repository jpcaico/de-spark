...
OPTIONS (path "/Users/jalvi/Desktop/jp-repos/de-spark/docs/files/device/*.json")          
...
USING org.apache.spark.sql.json
OPTIONS (path "/Users/jalvi/Desktop/jp-repos/de-spark/docs/files/subscription/*.json")          
